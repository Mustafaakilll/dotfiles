...
def translate(word_list, dictionary):
    converted_words=[]
    try:
        color = dictionary[word_list[0]][0][0]
        field2 = dictionary[word_list[1]][0][0]
    except KeyError:
        print("Word not found in dictionary")

    kalem = dictionary[word_list[2]].pop(0)[0]
    converted_words.append(color)
    converted_words.append(field2)
    converted_words.append(kalem)
