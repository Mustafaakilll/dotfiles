...
\begin{frame}{Deep Models }
  \begin{figure}
    \centering
    \includegraphics[width=1.2\textwidth]{sekil4}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}[]
    \includegraphics[width=1.2\textwidth]{sekil7}
    \label{fig:sekil3}
...
\begin{figure}[]
  \centering
  \includegraphics[width=1.25\textwidth, height=0.7\textheight]{sekil8}
  \label{fig:sekil4}
...
\begin{frame}
  \begin{figure}[]
    \centering
    \includegraphics[width=1.1\textwidth, height=0.7\textheight]{sekil9}
    \label{fig:sekil5}
