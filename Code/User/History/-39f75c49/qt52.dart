...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  void initState() {
    super.initState();
    _usernameController = TextEditingController.fromValue(TextEditingValue(text: widget.user.username));
    _bioController = TextEditingController.fromValue(TextEditingValue(text: widget.user.bio));
    _emailController = TextEditingController.fromValue(TextEditingValue(text: widget.user.email));
