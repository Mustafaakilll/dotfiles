...
class EditProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<EditProfileBloc>(
      create: (context) => EditProfileBloc(userRepo: locator()),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      onChanged: (email) {
                        context.read<EditProfileBloc>().add(EditProfileEvent.emailChanged(email ?? user.email));
                      },
                      onFieldSubmitted: (email) {
                        debugPrint('onFieldSubmitted: $email');
                        // context.read<EditProfileBloc>().add(EditProfileEvent.saveUser(email));
                      },
                      decoration: InputDecoration(
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                        labelText: 'Email',
