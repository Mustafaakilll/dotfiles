...
set -gx PATH /usr/lib/jvm/java-11-openjdk/bin $PATH
# set -gx PATH /usr/lib/jvm/java-19-openjdk/bin $PATH
...
# MC with DRI_PRIME
alias mc='DRI_PRIME=1 prismlauncher'

# FZF
alias fzf="fzf --color fg:#D8DEE9,bg:#2E3440,hl:#A3BE8C,fg+:#D8DEE9,bg+:#434C5E,hl+:#A3BE8C"

# Intellij idea
alias idea='intellij-idea-ultimate-edition'

# Change keyboard layout
alias totr="setxkbmap -layout tr"
alias togb="setxkbmap -layout gb"
...
alias updocker="docker compose up"
alias builddocker="docker compose up --build"
...
# flutter
alias build_flutter='flutter pub run build_runner build'
alias build_clean_flutter='flutter pub run build_runner build --delete-conflicting-outputs'

# Changing "ls" to "exa"
alias ls='exa -albghm@ --color=always --icons --git --group-directories-first' # my preferred listing
alias la='exa -abghm@ --color=always --icons --git --group-directories-first'  # all files and dirs
alias ll='exa -l --color=always --icons --git --group-directories-first'  # long format
alias lt='exa -aT --color=always --icons --git --group-directories-first' # tree listing
alias l.='exa -a | egrep "^\."'
...
alias yayss='yay -Ss'                            # Search package
...
set -q XDG_CONFIG_DIRS || set -U XDG_CONFIG_DIRS $HOME/.config
